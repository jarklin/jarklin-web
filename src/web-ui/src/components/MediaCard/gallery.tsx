...
export default function GalleryCard(props: Props) {
    ...
    return <div className={twMerge("aspect-portrait bg-primary-light rounded-md overflow-hidden relative group", props.className)}>
        ...
        <span className="absolute inset-x-0 bottom-0 px-1 bg-gradient-to-t from-black/50 via-black/50 to-transparent drop-shadow-highlight line-clamp-3">{media.displayName}</span>
    </div>;
}
