...
export default function VideoCard(props: Props) {
    ...
    return <div className={twMerge("aspect-video bg-primary-light rounded-md overflow-hidden relative isolate group", props.className)}>
        ...
        <span className="absolute inset-x-0 bottom-0 px-1 bg-gradient-to-t from-75% from-black/50 drop-shadow-highlight line-clamp-2 z-10 font-bold">{media.displayName}</span>
    </div>;
}
